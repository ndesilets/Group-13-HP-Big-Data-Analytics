...
BEGIN
  ...
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_NOI',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/

@index_tests/Tests_NUI.sql dr_part_id_sub_date_16

-- GLOBAL INDEX EXPERIMENTS
--------------------------------------------------------------------------------
-- Primary key experiment (Non-prefix)
--------------------------------------------------------------------------------
ALTER TABLE dr_part_id_sub_date_16 DROP CONSTRAINT non_prefix_key;
ALTER TABLE dr_part_id_sub_date_16 ADD CONSTRAINT non_prefix_key PRIMARY KEY(press_local_time,device_id, measurement_type_key, measurement);

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_PK_NP',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/

@index_tests/Overlap_Tests_Date.sql dr_part_id_sub_date_16

ALTER TABLE dr_part_id_sub_date_16 DROP CONSTRAINT non_prefix_key;
----------------------------------------------------------------------------------
---- Primary key experiment (Prefix)
----------------------------------------------------------------------------------
ALTER TABLE dr_part_id_sub_date_16 DROP CONSTRAINT prefix_key;
ALTER TABLE dr_part_id_sub_date_16 ADD CONSTRAINT prefix_key PRIMARY KEY(device_id, press_local_time,  measurement_type_key, measurement);

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_PK_P',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/

@index_tests/Overlap_Tests_ID.sql dr_part_id_sub_date_16
...
CREATE UNIQUE INDEX unique_NP_index ON dr_part_id_sub_date_16(press_local_time,device_id, measurement_type_key, measurement);

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_UI_NP',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/
...
CREATE UNIQUE INDEX unique_P_index ON dr_part_id_sub_date_16(device_id, press_local_time,  measurement_type_key, measurement);

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_UI_P',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/
...
CREATE INDEX nonunique_NP_index ON dr_part_id_sub_date_16(press_local_time, device_id, measurement_type_key, measurement);

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_NUI_NP',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/
...
CREATE INDEX nonunique_P_index ON dr_part_id_sub_date_16(device_id, press_local_time,  measurement_type_key, measurement);

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_NUI_P',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/
...
CREATE UNIQUE INDEX local_NP_unique ON dr_part_id_sub_date_16(press_local_time, device_id, measurement_type_key, measurement) LOCAL;

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_LUI_NP',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/
...
CREATE UNIQUE INDEX local_P_unique ON dr_part_id_sub_date_16(device_id, press_local_time, measurement_type_key, measurement) LOCAL;

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_ID_S_DATE_OVERLAP_LUI_P',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/
...
CREATE INDEX local_NP_nonunique ON dr_part_id_sub_date_16(press_local_time, device_id, measurement_type_key, measurement) LOCAL;

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_DAY__S_DATE_OVERLAP_LNUI_NP',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/
...
CREATE INDEX local_P_nonunique ON dr_part_id_sub_date_16(device_id, press_local_time, measurement_type_key, measurement) LOCAL;

BEGIN
  DBMS_LOCK.SLEEP(SECONDS => 30);
  DBMS_APPLICATION_INFO.SET_MODULE(MODULE_NAME => 'PART_BY_DAY_S_DATE_OVERLAP_LNUI_P',ACTION_NAME => 'RESOURCE_MONITORING'); 
  DBMS_APPLICATION_INFO.SET_CLIENT_INFO(CLIENT_INFO => 'STANDARD_QUERY');
END;
/
