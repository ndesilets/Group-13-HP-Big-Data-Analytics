--------------------------------------------------------------------------------
-- Overlapping Data Tests for Prefix or Unique Index Prefix for ID
--------------------------------------------------------------------------------
-- Only running in serial due to hint
ALTER SYSTEM FLUSH SHARED_POOL;
INSERT /*+ PARALLEL(8) IGNORE_ROW_ON_DUPKEY_INDEX(&1(device_id, press_local_time, measurement_type_key, measurement))*/
