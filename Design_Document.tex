...
\subsection{Examples}
\begin{center}
	\includegraphics[width=4in]{sql_worksheet_example.png}
...
\section{Conclusion}
The toolkit that are creating consists of multiple interacting entities including the end users, Oracle Database 12c, and SQL Developer. 
