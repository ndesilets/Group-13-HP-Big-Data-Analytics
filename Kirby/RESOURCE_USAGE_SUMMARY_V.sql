...
SELECT
  ...
  SUM(NVL(GROUP_BY_HASH_NUMBER_PASSES,0))/POWER(1024,3) AS GROUP_BY_NUMBER_PASSES_GB,
  ...
  SUM(NVL(SORT_V2_NUMBER_PASSES,0))/POWER(1024,3) AS SORT_V2_NUMBER_PASSES_GB,
  ...
  SUM(NVL(HASH_JOIN_NUMBER_PASSES,0))/POWER(1024,3) AS HASH_JOIN_NUMBER_PASSES_GB,
  ...
  SUM(NVL(WINDOW_SORT_NUMBER_PASSES,0))/POWER(1024,3) AS WINDOW_SORT_NUMBER_PASSES_GB,
