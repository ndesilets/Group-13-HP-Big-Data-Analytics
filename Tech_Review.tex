...
What SQL doesn’t have is any active 
...
Also because TOAD is paid for, the service tries to be much more proactive in helping developers.
...
TOAD was included to examine a paid for IDE to try and evaluate the potential advantages of using a paid for IDE instead of a free one.
Being a paid for service, TOAD can provide a larger number of features that are also more powerful.
There are many features that TOAD can provide that neither of the other two options can, such as version control, automatic testing, and change management.
Ultimately TOAD provides functionality that simply isn’t important to us, while it may be useful to others it isn’t worth the cost to us.
