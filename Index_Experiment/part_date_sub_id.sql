...
--------------------------------------------------------------------------------
ALTER TABLE dr_part_date_sub_id_16 DROP CONSTRAINT p_key;
ALTER TABLE dr_part_date_sub_id_16 ADD CONSTRAINT p_key PRIMARY KEY(device_id, press_local_time,  measurement_type_key, measurement);
...
CREATE UNIQUE INDEX unique_index ON dr_part_date_sub_id_16(device_id, press_local_time,  measurement_type_key, measurement);
...
CREATE INDEX nonunique_index ON dr_part_date_sub_id_16(device_id, press_local_time,  measurement_type_key, measurement);
-- Insert query
INSERT /*+ PARALLEL(8) */
  INTO dr_part_date_sub_id_16 (device_id, press_local_time, measurement_type_key, measurement) 
  (SELECT device_id, press_local_time, measurement_type_key, measurement FROM data_loader);
